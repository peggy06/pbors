...
@section('content')
    <div class="registration-container">
        {!! Form::open(['url'=>route('admin.company.update',['company'=>$company->id]),'method'=>'put','files'=>true]) !!}
        <div class="registration-form-container bg--white one-column-layout">
            @include('partials.messages')
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="material-input-container">
                        <input type="text" name="name" class="material-input" required=required value="{{$company->name}}"/>
