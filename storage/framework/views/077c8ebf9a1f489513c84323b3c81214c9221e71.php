<?php $__env->startSection('content'); ?>
    ...
    <div class="registration-container">
        ...
        <?php echo Form::open(['url'=>route('client.routes.update',['route'=>$route->id,]),'method'=>'put']); ?>
        ...
        <div class="registration-form-container bg--white one-column-layout">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="material-input-container">
                        <input type="text" name="name" value="<?php echo e(old('name',$route->name)); ?>" class="material-input" required=required/>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="material-input-container">
                        <input type="text" name="location" value="<?php echo e(old('location',$route->location)); ?>" class="material-input" required=required/>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <div class="material-input-container">
                        <input type="text" name="region" class="material-input" value="<?php echo e(old('region',$route->region)); ?>" required=required/>
